...
//    @Test
//    void givenExistingPhoto_whenUpdate_thenPhotoUpdatedAndReturned() {
//        // given
//        Photo photo = new Photo();
//        photo.setId(1L);
//        PhotoEntity photoEntity = new PhotoEntity();
//        when(photoRepository.findById(photo.getId())).thenReturn(Optional.of(photoEntity));
//        when(photoRepository.save(photoEntity)).thenReturn(photoEntity);
//        when(photoMapper.fromEntity(photoEntity)).thenReturn(photo);
//
//        // when
//        Photo result = photoService.update(photo);
//
//        // then
//        verify(photoRepository).findById(photo.getId());
//        verify(photoMapper).updateImageFromDto(photo, photoEntity);
//        verify(photoMapper).toEntity(photo);
//        verify(photoRepository).save(photoEntity);
//        verify(photoMapper).fromEntity(photoEntity);
//        assertThat(result).isEqualTo(photo);
//    }
//
//    @Test
//    void givenExistingPhotoAndTimestamp_whenGetPhotoAtTime_thenPhotoReturned() {
//        // given
//        Long photoId = 1L;
//        LocalDateTime timestamp = LocalDateTime.now();
//        PhotoAuditEntity photoAuditEntity = new PhotoAuditEntity();
//        PhotoEntity photoEntity = new PhotoEntity();
//        when(photoAuditRepository.findByIdAndClosestUpdatedAt(photoId, timestamp)).thenReturn(Optional.of(photoAuditEntity));
//        when(photoAuditEntity.getPhoto()).thenReturn(photoEntity);
//        when(photoMapper.fromEntity(photoEntity)).thenReturn(new Photo());
//
//        // when
//        Photo result = photoService.getPhotoAtTime(photoId, timestamp);
//
//        // then
//        verify(photoAuditRepository).findByIdAndClosestUpdatedAt(photoId, timestamp);
//        verify(photoMapper).fromEntity(photoEntity);
//        assertThat(result).isNotNull();
//    }
//
//    @Test
//    void givenNoTag_whenFindPhotos_thenAllPhotosReturned() {
//        // given
//        Integer pageNo = 0;
//        Integer pageSize = 10;
//        String order = null;
...
//        photoEntities.add(new PhotoEntity());
//        Page<PhotoEntity> page = new PageImpl<>(photoEntities, pageable, photoEntities.size());
//        when(photoRepository.findAll(pageable)).thenReturn(page);
//        when(photoMapper.fromEntity(any(PhotoEntity.class))).thenReturn(new Photo());
//
//        // when
//        List<Photo> result = photoService.findPhotos(null, pageNo, pageSize, order);
//
//        // then
//        verify(photoRepository).findAll(pageable);
//        verify(photoMapper, times(2)).fromEntity(any(PhotoEntity.class));
